        ...
        rows: [
            ...
            },
            {
                ...
                columns: [
                    ...
                    { id: "code_", header: { text: "流程编码", css: { "text-align": "center" } }, sort: "text", width: 100 },
                    { id: "name_", header: { text: "流程名称", css: { "text-align": "center" } }, sort: "text", width: 160 },
                    ...
                    { id: "publish_at_", header: { text: "发布时间", css: { "text-align": "center" } }, sort: "date", format: utils.formats["datetime"].format, width: 140, css: { "text-align": "center" } },
                    {
                        ...
                        template: `<div class="webix_el_box" style="padding:0px; text-align:center">
                                        ...
                                        <button webix_tooltip="发布" type="button" class="btn_sync webix_icon_button" style="height:30px;width:30px;">
                ...
                onClick: {
                    ...
                    btn_remove(e, item) {
                        ...
                        utils.grid.remove($$(grid_id), null, "流程实例", "code_")
                    },
                    btn_sync(e, item) {
                        // var row = this.getItem(item.row);
                        // if (!row["sync_status_"]) return;
